...
public class NavMeshMeleeMove : UnitSateNavMeshMove
{
    ...
    private bool TryChaseUnit() {
        bool hasEnemy = MapInfo.Instance.TryGetNearestGroundUnit(_unit.transform.position, _targetIsEnemy, out Unit enemy, out float distance);
